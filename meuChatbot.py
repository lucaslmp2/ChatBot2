...
btree.insert(45, "historia")

# Dicionário que mapeia palavras-chave a respostas
responses = {
    "Oi": "Oi, eu sou o Guru do Campeonato Brasileiro...",
    "Ola": "Oi, eu sou o Guru do Campeonato Brasileiro...",
    "Tudo bem": "Oi, tudo sim e você? Eu sou o Guru do Campeonato Brasileiro...",
    ...
    "Tecnico do cuiabá": "O técnico do Cuiabá é o Toni Oliveira",
...
with open('clubes.json', 'r') as file:
...
with open('maiorCampeao.json', 'r') as file:
